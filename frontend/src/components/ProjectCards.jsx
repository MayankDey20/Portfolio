                      ...
                      {project.githubUrl && (
                        <div className="absolute top-8 right-8 z-20">
                          <a 
                            ...
                            className={`p-2 rounded-full border border-white/5 bg-black/20 backdrop-blur-md transition-all duration-300 opacity-40 hover:opacity-100 hover:scale-110 ${
                              project.glowColor === 'blue' ? 'hover:border-blue-500/50 text-blue-400' : 
                              project.glowColor === 'green' ? 'hover:border-green-500/50 text-green-400' : 
