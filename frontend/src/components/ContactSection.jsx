        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-8 items-center mt-auto">
            ...
            <div className="flex gap-12 ml-4">
              <a href="#" className="text-white/20 hover:text-white transition-all duration-500 flex flex-col items-center group">
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="group">
                ...
                <input 
                  ...
                  placeholder="MAYANK.DEY@UNIVERSITY.EDU"
                />
              </div>
